...
export const TeamDetailView = ({
  ...
  // selectReviewFile: editor slice removed — no-op stub
  const selectReviewFile = (_filePath: string): void => {};
  ...
  // editorPendingRevealFile: editor slice removed — no-op
  // (ProjectEditorOverlay and editor slice have been removed)
          ...
          <div className="relative min-h-0 min-w-0 flex-1">
            ...
            >
              ...
              <TaskDetailDialog
                ...
                onOpenInEditor={(_filePath) => {
                  // revealFileInEditor: editor slice removed — no-op
                }}
                onDeleteTask={handleDeleteTask}
              />
